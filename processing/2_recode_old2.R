...
rec_vars <- list(
    emper_transporte_pct = c(paste0("emper_p_inseg_lugares_", 1:6)), # Todos los lugares menos plazas del barrio y negocios del barrio
    emper_recreacion_pct = c(paste0("emper_p_inseg_lugares_", c(7, 10)),
